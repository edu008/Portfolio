  ...
  return (
    ...
    <body className='min-h-screen md:px-36 md:py-16 md:pb-4 px-8 py-12 bg-[white] select-none md:w-6/12 md:pr-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]'>
      <div className='text-center'>
        ...
        <br />
        <h1 className='text-left font-medium text-7xl md:text-8xl font-rubix bg-gradient-to-r from-[#833be7cb] to-[#5521c5] bg-clip-text text-transparent'>Eduan</h1>
        <h1 className='text-left md:pb-6 pt-2 md:pt-0 pb-7 leading-10 font-semibold text-6xl md:text-7xl font-rubix'>Roci</h1>
      ...
      <div className='text-[rgb(15,23,42)] text-center'>
         <h1 className='text-left md:pt-8 text-2xl font-poppins font-normal'>I am a passionate 
            <span className='text-left md:pt-8 text-3xl font-semibold font-rubix'> IT <br></br> enthusiast.</span>
         </h1>
      </div>
